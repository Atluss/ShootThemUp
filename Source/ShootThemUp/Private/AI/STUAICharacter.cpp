...
void ASTUAICharacter::UpdateHealthWidgetVisibility()
{
    ...
    const auto PlayerController = GetWorld()->GetFirstPlayerController()->GetPawnOrSpectator()->GetActorLocation();
    const auto Distance = FVector::Distance(PlayerController, GetActorLocation());
